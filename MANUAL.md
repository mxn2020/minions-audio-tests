# Manual Setup Steps for Minions Audio-tests
...
Go to **GitHub → mxn2020/minions-audio-tests → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-audio-tests` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-audio-tests-web`
- **GitHub repo**: `mxn2020/minions-audio-tests`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `audio-tests.minions.wtf`

### Documentation
- **Netlify site name**: `minions-audio-tests-docs`
- **GitHub repo**: `mxn2020/minions-audio-tests`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `audio-tests.minions.help`

### Blog
- **Netlify site name**: `minions-audio-tests-blog`
- **GitHub repo**: `mxn2020/minions-audio-tests`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `audio-tests.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `audio-tests.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `audio-tests.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `audio-tests.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-audio-tests/sdk`](https://www.npmjs.com/package/@minions-audio-tests/sdk)
- CLI: [`@minions-audio-tests/cli`](https://www.npmjs.com/package/@minions-audio-tests/cli)
...
Your package: [`minions-audio-tests`](https://pypi.org/project/minions-audio-tests/)
...
| Item | Value |
|------|-------|
| Project | `minions-audio-tests` |
| SDK (npm) | `@minions-audio-tests/sdk` |
| CLI (npm) | `@minions-audio-tests/cli` |
| Python (PyPI) | `minions-audio-tests` |
| GitHub | `github.com/mxn2020/minions-audio-tests` |
| Docs domain | `audio-tests.minions.help` |
| Blog domain | `audio-tests.minions.blog` |
| App domain | `audio-tests.minions.wtf` |
