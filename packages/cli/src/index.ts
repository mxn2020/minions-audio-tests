...
/**
 * @minions-audio-tests/cli — CLI for Minions Audio-tests
 *
...
import { customTypes } from '@minions-audio-tests/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Audio-tests'));
        console.log(chalk.dim('Voice interaction configs, TTS/STT pipeline settings, and audio samples'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-audio-tests/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-audio-tests/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-audio-tests')}`);
